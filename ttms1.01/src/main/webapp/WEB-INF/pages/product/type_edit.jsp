	 ...
	 <div class="row col-md-12">
	  <form class="form-horizontal" id="editTypeForm">
	            <div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" id="typeNameId"  placeholder="分类名称" class="form-control dynamicClear required" style="width:650px;">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" id="parentNameId" readonly="readonly" placeholder="一级分类"
							class="form-control required dynamicClear load-product-type" style="cursor: pointer;width:650px">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="number" id="typeSortId" placeholder="排序号" class="form-control required dynamicClear" style="width:650px;">
					</div>
				</div>
					<div class="form-group">
		            <label for="noteId" class="col-sm-2 control-label">备注:</label>
		            <div class="col-sm-10">
		            <textarea class="form-control"  id="typeNoteId" style="width:650px;"></textarea>
		           </div> 
	            </div>
				<div class="form-group">
